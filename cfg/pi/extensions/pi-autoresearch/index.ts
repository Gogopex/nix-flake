 ...
 * - Ctrl+Shift+A toggle to expand/collapse full dashboard inline above the editor
...
export default function autoresearchExtension(pi: ExtensionAPI) {
  ...
  const updateWidget = (ctx: ExtensionContext) => {
    ...
    if (runtime.dashboardExpanded) {
      ...
      ctx.ui.setWidget("autoresearch", (_tui, theme) => {
        ...
        const hintText = " ctrl+shift+a collapse • ctrl+shift+x fullscreen ";
      ...
      ctx.ui.setWidget("autoresearch", (_tui, theme) => {
        ...
        parts.push(theme.fg("dim", "  (ctrl+shift+a expand • ctrl+shift+x fullscreen)"));
  ...
  // -----------------------------------------------------------------------
  // Ctrl+Shift+A — toggle dashboard expand/collapse
  // -----------------------------------------------------------------------
